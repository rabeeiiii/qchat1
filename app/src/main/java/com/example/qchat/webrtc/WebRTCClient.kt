...
import com.example.qchat.utils.DataModel
import com.example.qchat.utils.DataModelType
...
class WebRTCClient @Inject constructor(
    ...
    //negotiation section
    fun call(target: String, isVideoCall: Boolean) {
        if (isVideoCall) {
            // Adjust your media constraints for video
            mediaConstraint.mandatory.add(MediaConstraints.KeyValuePair("OfferToReceiveVideo", "true"))
        } else {
            // Adjust for voice call only
            mediaConstraint.mandatory.add(MediaConstraints.KeyValuePair("OfferToReceiveAudio", "true"))
        }
